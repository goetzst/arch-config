...
## Type: QssColor
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 black, stop:1 black)'

## Bottom border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.bottom = 'grey'

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.top = 'grey'
...
## Type: Font
c.fonts.monospace = '"Dejavu Sans Mono", "xos4 Terminus", Terminus, Monospace, monospace, Fixed, Consolas, Terminal'
...
config.bind('<Ctrl-C>'          , 'set -t content.user_stylesheets ~/workspace/solarized-everything-css/css/solarized-all-sites-light.css ;; reload')
config.bind('<Ctrl-Shift-C>'    , 'set -t content.user_stylesheets ~/workspace/solarized-everything-css/css/solarized-all-sites-dark.css ;; reload')
config.bind('<Ctrl-Alt-C>'      , 'set -t content.user_stylesheets \'\' ;; reload')
config.bind('<Ctrl-Alt-Shift-C>', 'set -t content.user_stylesheets ~/.config/qutebrowser/css/global.css ;; reload')
